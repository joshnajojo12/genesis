...
import { Printer, Shield, Mail, Lock } from "lucide-react";
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message.includes("Email not confirmed")) {
        ...
        toast.error("Invalid email or password. If you used Google, please sign in with Google.");
      } else {
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tight">Welcome to SecurePrint</h1>
            <p className="text-muted-foreground">
              Secure, One-Time, Protected Printing System
            </p>
          </div>
        </div>
        ...
        <div className="p-8 bg-card rounded-xl border shadow-sm space-y-6">
          ...
          <div className="space-y-2 text-sm text-muted-foreground pt-4 border-t text-center">
